...
```bash
docker pull ghcr.io/skibare87/muninn:0.3.0
...
docker run -d --name muninn -p 8080:8080 \
  ...
  ghcr.io/skibare87/muninn:0.3.0
```
...
| tag | meaning |
|---|---|
| `0.3.0`, `0.3` | immutable release — **pin this on a fleet** |
